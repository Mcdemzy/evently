  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-[8px] text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        login: "text-black dark:text-white dark:bg-black bg-gray-50 hover:bg-primary/10",
        signup: "bg-primary text-white hover:bg-primary/90",
        explorenow: "bg-primary text-white hover:bg-primary/90 w-full sm:w-fit",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-7 rounded-[8px] px-3",
        lg: "h-9 rounded-[8px] px-8",
        xl: "h-12 rounded-[8px] px-8",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
